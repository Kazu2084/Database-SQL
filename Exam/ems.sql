...
CREATE TABLE `examinee_tbl` (
  ...
  `exmne_subject` varchar(1000) NOT NULL,
...
INSERT INTO `examinee_tbl` (`exmne_id`, `exmne_fullname`, `exmne_subject`, `exmne_gender`, `exmne_birthdate`, `exmne_year_level`, `exmne_email`, `exmne_password`, `exmne_status`) VALUES
(5, 'Jane Rivera', '25', 'female', '2019-11-14', 'second year', 'jane@gmail.com', 'jane', 'active'),
(6, 'Glenn Duerme', '26', 'male', '2019-12-24', 'third year', 'glenn@gmail.com', 'glenn', 'active'),
(7, 'Maria Duerme', '26', 'female', '2018-11-25', 'second year', 'maria@gmail.com', 'maria', 'active'),
(8, 'Dave Limasac', '26', 'male', '2019-12-21', 'second year', 'dave@gmail.com', 'dave', 'active'),
(10, 'marta cabrera', '26', 'female', '2023-05-11', 'second year', 'marta@gmail.com', 'marta', 'active'),
(11, 'dsd', '26', 'male', '2023-05-17', 'second year', 'dsd@gmail.com', 'dsd', 'active');
...
INSERT INTO `exam_tbl` (`ex_id`, `sub_id`, `ex_title`, `ex_time_limit`, `ex_questlimit_display`, `ex_description`, `ex_created`) VALUES
(11, 26, 'Duerms', '1', 2, 'qwe', '2019-12-05 06:33:21'),
(12, 26, 'Another Exam', '1', 5, 'Mabilisang Exam', '2019-12-04 09:49:18'),
(13, 0, '', '', 0, '', '2023-05-13 06:36:54'),
(24, 0, '', '', 0, '', '2023-05-13 06:38:48'),
(26, 26, '', '', 0, '', '2023-05-13 06:23:50');
...
(22, 'glenn@gmail.com', 'glenn', 'Student'),
(23, 'glenn@gmail.com', 'glenn', 'Student');
...
INSERT INTO `subject_tbl` (`sub_id`, `sub_name`, `sub_created`) VALUES
(25, 'JAVA', '2023-04-27 03:56:08'),
(26, 'DBMS', '2023-04-25 07:52:42'),
(65, 'LDMS', '2023-04-02 03:55:36');
