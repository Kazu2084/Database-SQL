...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 09, 2023 at 06:26 AM
...
(13, 'Daily stoic', 7, 'Ryan', '', '', '', '', 3, '', '', '45342', 0, 'New', 'VNHS10LMS', 'IMG_0019.JPG', '2023-05-15 00:20:26', 'Available');
...
(1, 'admin@gmail.com', 'admin123*', 'Librarian'),
...
(41, 'kaguya@gmail.com', 'kaguya', 'Student');
...
(40, '117479070029', 'Kurisu', 'MALAPITAN', 'ANIAN', '', 'Female', 'BARANGAY 16 (POB.), BACOLOD CITY (Capital)', 'Student', 'Grade 8', 'Charity', '', 'Active', '2015-12-14 08:36:01'),
(41, '6356', 'Kaguya', '', 'makise', '', 'Female', '', 'Student', 'Grade 10', '34', '', 'Active', '2023-05-16 19:24:00');
...
--
ALTER TABLE `barcode`
  MODIFY `barcode_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
